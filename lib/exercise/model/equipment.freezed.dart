...
/// @nodoc
@JsonSerializable()
class _$EquipmentImpl with DiagnosticableTreeMixin implements _Equipment {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Equipment(id: $id, name: $name, isSelected: $isSelected)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Equipment'))
...
abstract class _Equipment implements Equipment {
  const factory _Equipment(
      ...
      final bool isSelected}) = _$EquipmentImpl;
